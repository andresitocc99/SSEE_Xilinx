set moduleName hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_83_1_VITIS_LOOP_84_2_VITIS_LOOP_85_s
set isTopModule 0
...
set hasInterrupt 0
set C_modelName {hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_83_1_VITIS_LOOP_84_2_VITIS_LOOP_85_}
set C_modelType { void 0 }
set C_modelArgList {
	{ image_r int 16 regular {array 368640 { 0 0 } 0 1 }  }
...
set C_modelArgMapList {[ 
	{ "Name" : "image_r", "interface" : "memory", "bitwidth" : 16, "direction" : "WRITEONLY"} , 
...
set portList { 
	...
	{ image_r_d0 sc_out sc_lv 16 signal 0 } 
	{ image_r_address1 sc_out sc_lv 19 signal 0 } 
	{ image_r_ce1 sc_out sc_logic 1 signal 0 } 
	{ image_r_we1 sc_out sc_logic 1 signal 0 } 
	{ image_r_d1 sc_out sc_lv 16 signal 0 } 
	...
	{ in_stream_TUSER sc_in sc_lv 4 signal 4 } 
	{ in_stream_TLAST sc_in sc_lv 1 signal 5 } 
	{ in_stream_TID sc_in sc_lv 5 signal 6 } 
	{ in_stream_TDEST sc_in sc_lv 5 signal 7 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "image_r_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "image_r", "role": "d0" }} , 
 	...
 	{ "name": "image_r_d1", "direction": "out", "datatype": "sc_lv", "bitwidth":16, "type": "signal", "bundle":{"name": "image_r", "role": "d1" }} , 
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.am_addmul_12ns_11ns_8ns_19_4_1_U1", "Parent" : "0"},
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "184324", "Max" : "184324"}
	, {"Name" : "Interval", "Min" : "184324", "Max" : "184324"}
]}
...
set Spec2ImplPortList { 
	image_r { ap_memory {  { image_r_address0 mem_address 1 19 }  { image_r_ce0 mem_ce 1 1 }  { image_r_we0 mem_we 1 1 }  { image_r_d0 mem_din 1 16 }  { image_r_address1 MemPortADDR2 1 19 }  { image_r_ce1 MemPortCE2 1 1 }  { image_r_we1 MemPortWE2 1 1 }  { image_r_d1 MemPortDIN2 1 16 } } }

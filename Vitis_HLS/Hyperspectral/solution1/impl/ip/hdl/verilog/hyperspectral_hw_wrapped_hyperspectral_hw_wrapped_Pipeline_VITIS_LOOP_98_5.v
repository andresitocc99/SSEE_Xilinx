...
module hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_98_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        in_stream_TDEST,
        refPixel_1_049_out,
        refPixel_1_049_out_ap_vld,
        refPixel_0_048_out,
        refPixel_0_048_out_ap_vld
);
...
output  [31:0] refPixel_1_049_out;
output   refPixel_1_049_out_ap_vld;
output  [31:0] refPixel_0_048_out;
output   refPixel_0_048_out_ap_vld;

reg ap_idle;
reg in_stream_TREADY;
reg refPixel_1_049_out_ap_vld;
reg refPixel_0_048_out_ap_vld;

(* fsm_encoding = "none" *) reg   [0:0] ap_CS_fsm;
wire    ap_CS_fsm_state1;
wire   [0:0] icmp_ln98_fu_138_p2;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue_int == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start_int == 1'b0) | ((icmp_ln98_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_229)) begin
        if ((icmp_ln98_fu_138_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln98_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (icmp_ln98_fu_138_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b0) | ((icmp_ln98_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0)))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln98_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (icmp_ln98_fu_138_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln98_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done_int = 1'b1;
    end else begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln98_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_ready_int = 1'b1;
    end else begin
        ap_ready_int = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln98_fu_138_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln98_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (icmp_ln98_fu_138_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
        refPixel_0_048_out_ap_vld = 1'b1;
    end else begin
        refPixel_0_048_out_ap_vld = 1'b0;
    end
end

always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln98_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (icmp_ln98_fu_138_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
        refPixel_1_049_out_ap_vld = 1'b1;
    end else begin
        refPixel_1_049_out_ap_vld = 1'b0;
    end
end
...
assign add_ln98_fu_144_p2 = (ap_sig_allocacmp_i_1 + 2'd1);

assign ap_CS_fsm_state1 = ap_CS_fsm[32'd0];

always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_start_int == 1'b0) | ((icmp_ln98_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0)));
end

always @ (*) begin
    ap_condition_229 = (~((ap_start_int == 1'b0) | ((icmp_ln98_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1));
end

assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage0;

assign icmp_ln98_fu_138_p2 = ((ap_sig_allocacmp_i_1 == 2'd2) ? 1'b1 : 1'b0);
...
assign refPixel_0_048_out = refPixel_1_fu_90;

assign refPixel_1_049_out = refPixel_1_3_fu_94;

assign refPixel_1_5_fu_300_p3 = ((trunc_ln103_fu_296_p1[0:0] == 1'b1) ? result_V_fu_288_p3 : refPixel_1_3_fu_94);

assign refPixel_1_6_fu_308_p3 = ((trunc_ln103_fu_296_p1[0:0] == 1'b1) ? refPixel_1_fu_90 : result_V_fu_288_p3);
...
assign tmp_9_fu_264_p4 = {{r_V_1_fu_246_p2[55:24]}};

assign tmp_fu_252_p3 = r_V_fu_240_p2[32'd24];

assign trunc_ln103_fu_296_p1 = ap_sig_allocacmp_i_1[0:0];

assign ush_fu_224_p3 = ((isNeg_fu_206_p3[0:0] == 1'b1) ? sext_ln1512_fu_220_p1 : add_ln346_fu_200_p2);

assign val_fu_274_p3 = ((isNeg_fu_206_p3[0:0] == 1'b1) ? zext_ln818_fu_260_p1 : tmp_9_fu_264_p4);
...
endmodule //hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_98_5

set SynModuleInfo {
  {SRCNAME hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_100_1_VITIS_LOOP_101_2_VITIS_LOOP_1 MODELNAME hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_100_1_VITIS_LOOP_101_2_VITIS_LOOP_1 RTLNAME hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_100_1_VITIS_LOOP_101_2_VITIS_LOOP_1
    SUBMODULES {
  ...
  {SRCNAME hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_114_5 MODELNAME hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_114_5 RTLNAME hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_114_5}
  {SRCNAME hyperspectral_hw_wrapped_Pipeline_L3 MODELNAME hyperspectral_hw_wrapped_Pipeline_L3 RTLNAME hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_L3
    SUBMODULES {
      {MODELNAME hyperspectral_hw_wrapped_fsub_32ns_32ns_32_5_full_dsp_1 RTLNAME hyperspectral_hw_wrapped_fsub_32ns_32ns_32_5_full_dsp_1 BINDTYPE op TYPE fsub IMPL fulldsp LATENCY 4 ALLOW_PRAGMA 1}
  ...
  {SRCNAME hyperspectral_hw_wrapped_Pipeline_L4 MODELNAME hyperspectral_hw_wrapped_Pipeline_L4 RTLNAME hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_L4
    SUBMODULES {
      {MODELNAME hyperspectral_hw_wrapped_fadd_32ns_32ns_32_4_no_dsp_1 RTLNAME hyperspectral_hw_wrapped_fadd_32ns_32ns_32_4_no_dsp_1 BINDTYPE op TYPE fadd IMPL fabric LATENCY 3 ALLOW_PRAGMA 1}
    }
  }
  {SRCNAME hyperspectral_hw_wrapped_Pipeline_L5 MODELNAME hyperspectral_hw_wrapped_Pipeline_L5 RTLNAME hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_L5}
  {SRCNAME hyperspectral_hw_wrapped_Pipeline_L6 MODELNAME hyperspectral_hw_wrapped_Pipeline_L6 RTLNAME hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_L6}
  {SRCNAME hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_129_6 MODELNAME hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_129_6 RTLNAME hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_129_6}
  {SRCNAME hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_161_7 MODELNAME hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_161_7 RTLNAME hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_161_7}
  {SRCNAME hyperspectral_hw_wrapped MODELNAME hyperspectral_hw_wrapped RTLNAME hyperspectral_hw_wrapped IS_TOP 1
    SUBMODULES {
      ...
      {MODELNAME hyperspectral_hw_wrapped_fifo_w32_d2_S RTLNAME hyperspectral_hw_wrapped_fifo_w32_d2_S BINDTYPE storage TYPE fifo IMPL srl ALLOW_PRAGMA 1 INSTNAME {$InstName}}

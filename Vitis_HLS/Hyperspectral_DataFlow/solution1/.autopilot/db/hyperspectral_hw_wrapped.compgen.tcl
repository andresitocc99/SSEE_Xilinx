...
set ID 757
set hasByteEnable 0
set MemName hyperspectral_hw_wrapped_pixels_RAM_AUTO_1R1W
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler hyperspectral_hw_wrapped_CONTROL_BUS_s_axi BINDTYPE interface TYPE interface_s_axilite
}

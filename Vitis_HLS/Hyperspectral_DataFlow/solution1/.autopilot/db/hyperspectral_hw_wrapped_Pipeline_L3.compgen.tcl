...
set name hyperspectral_hw_wrapped_fsub_32ns_32ns_32_5_full_dsp_1
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { sum_stream_din { O 32 vector } sum_stream_full_n { I 1 bit } sum_stream_write { O 1 bit } } \
} "
}

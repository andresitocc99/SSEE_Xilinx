...
set name hyperspectral_hw_wrapped_fadd_32ns_32ns_32_4_no_dsp_1
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_sum_stream \
    op interface \
    ports { sum_stream_dout { I 32 vector } sum_stream_empty_n { I 1 bit } sum_stream_read { O 1 bit } } \
} "
}

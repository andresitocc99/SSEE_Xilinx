...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_mul_ln17_1 \
    op interface \
    ports { mul_ln17_1 { I 19 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { brightness_stream_din { O 32 vector } brightness_stream_full_n { I 1 bit } brightness_stream_write { O 1 bit } } \
} "
}

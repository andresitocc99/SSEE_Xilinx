...
set id 1
set name hyperspectral_hw_wrapped_am_addmul_12ns_11ns_8ns_19_4_1
...
set ce_signed 0
set out_width 19
set arg_lists {i0 {12 0 +} i1 {11 0 +} s {13 0 +} i2 {8 0 +} p {19 1 +} c_expval {c} acc {0} }
set TrueReset 0
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename image_r \
    op interface \
    ports { image_r_address0 { O 19 vector } image_r_ce0 { O 1 bit } image_r_we0 { O 1 bit } image_r_d0 { O 16 vector } image_r_address1 { O 19 vector } image_r_ce1 { O 1 bit } image_r_we1 { O 1 bit } image_r_d1 { O 16 vector } } \
} "
} else {

...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename ref_pixel_V \
    op interface \
    ports { ref_pixel_V_address0 { O 8 vector } ref_pixel_V_ce0 { O 1 bit } ref_pixel_V_we0 { O 1 bit } ref_pixel_V_d0 { O 16 vector } ref_pixel_V_address1 { O 8 vector } ref_pixel_V_ce1 { O 1 bit } ref_pixel_V_we1 { O 1 bit } ref_pixel_V_d1 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'ref_pixel_V'"
}
}

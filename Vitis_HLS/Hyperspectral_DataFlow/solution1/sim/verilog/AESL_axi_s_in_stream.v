...
`define TV_IN_in_stream_TDATA "../tv/cdatafile/c.hyperspectral_hw_wrapped.autotvin_in_stream_V_data_V.dat"
`define INGRESS_STATUS_in_stream_TDATA "../tv/stream_size/stream_ingress_status_in_stream_V_data_V.dat"
`define TV_IN_in_stream_TKEEP "../tv/cdatafile/c.hyperspectral_hw_wrapped.autotvin_in_stream_V_keep_V.dat"
`define INGRESS_STATUS_in_stream_TKEEP "../tv/stream_size/stream_ingress_status_in_stream_V_keep_V.dat"
`define TV_IN_in_stream_TSTRB "../tv/cdatafile/c.hyperspectral_hw_wrapped.autotvin_in_stream_V_strb_V.dat"
`define INGRESS_STATUS_in_stream_TSTRB "../tv/stream_size/stream_ingress_status_in_stream_V_strb_V.dat"
`define TV_IN_in_stream_TUSER "../tv/cdatafile/c.hyperspectral_hw_wrapped.autotvin_in_stream_V_user_V.dat"
`define INGRESS_STATUS_in_stream_TUSER "../tv/stream_size/stream_ingress_status_in_stream_V_user_V.dat"
`define TV_IN_in_stream_TLAST "../tv/cdatafile/c.hyperspectral_hw_wrapped.autotvin_in_stream_V_last_V.dat"
`define INGRESS_STATUS_in_stream_TLAST "../tv/stream_size/stream_ingress_status_in_stream_V_last_V.dat"
`define TV_IN_in_stream_TID "../tv/cdatafile/c.hyperspectral_hw_wrapped.autotvin_in_stream_V_id_V.dat"
`define INGRESS_STATUS_in_stream_TID "../tv/stream_size/stream_ingress_status_in_stream_V_id_V.dat"
`define TV_IN_in_stream_TDEST "../tv/cdatafile/c.hyperspectral_hw_wrapped.autotvin_in_stream_V_dest_V.dat"
...
module AESL_axi_s_in_stream (
    ...
    output [4 - 1:0] TRAN_in_stream_TUSER,
    output TRAN_in_stream_TLAST,
    output [5 - 1:0] TRAN_in_stream_TID,
    output [5 - 1:0] TRAN_in_stream_TDEST,
    ...
    reg [4 - 1:0] in_stream_TUSER_write_data;
    ...
    reg [5 - 1:0] in_stream_TDEST_write_data;

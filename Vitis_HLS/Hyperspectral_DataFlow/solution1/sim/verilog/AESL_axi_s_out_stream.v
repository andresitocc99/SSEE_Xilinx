...
`define TV_OUT_out_stream_TDATA "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_data_V.dat"
`define EGRESS_STATUS_out_stream_TDATA "../tv/stream_size/stream_egress_status_out_stream_V_data_V.dat"
`define TV_OUT_out_stream_TKEEP "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_keep_V.dat"
`define EGRESS_STATUS_out_stream_TKEEP "../tv/stream_size/stream_egress_status_out_stream_V_keep_V.dat"
`define TV_OUT_out_stream_TSTRB "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_strb_V.dat"
`define EGRESS_STATUS_out_stream_TSTRB "../tv/stream_size/stream_egress_status_out_stream_V_strb_V.dat"
`define TV_OUT_out_stream_TUSER "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_user_V.dat"
`define EGRESS_STATUS_out_stream_TUSER "../tv/stream_size/stream_egress_status_out_stream_V_user_V.dat"
`define TV_OUT_out_stream_TLAST "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_last_V.dat"
`define EGRESS_STATUS_out_stream_TLAST "../tv/stream_size/stream_egress_status_out_stream_V_last_V.dat"
`define TV_OUT_out_stream_TID "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_id_V.dat"
`define EGRESS_STATUS_out_stream_TID "../tv/stream_size/stream_egress_status_out_stream_V_id_V.dat"
`define TV_OUT_out_stream_TDEST "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_dest_V.dat"
...
module AESL_axi_s_out_stream (
    ...
    input [4 - 1:0] TRAN_out_stream_TUSER,
    input TRAN_out_stream_TLAST,
    input [5 - 1:0] TRAN_out_stream_TID,
    input [5 - 1:0] TRAN_out_stream_TDEST,
    ...
    reg [4 - 1:0] out_stream_TUSER_write_data;
    ...
    reg [5 - 1:0] out_stream_TDEST_write_data;

...
`define AUTOTB_DUT      hyperspectral_hw_wrapped
`define AUTOTB_DUT_INST AESL_inst_hyperspectral_hw_wrapped
`define AUTOTB_TOP      apatb_hyperspectral_hw_wrapped_top
`define AUTOTB_LAT_RESULT_FILE "hyperspectral_hw_wrapped.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "hyperspectral_hw_wrapped.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_hyperspectral_hw_wrapped_top
...
`define AUTOTB_TVIN_in_stream_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvin_in_stream_V_data_V.dat"
`define AUTOTB_TVIN_in_stream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvin_in_stream_V_keep_V.dat"
`define AUTOTB_TVIN_in_stream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvin_in_stream_V_strb_V.dat"
`define AUTOTB_TVIN_in_stream_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvin_in_stream_V_user_V.dat"
`define AUTOTB_TVIN_in_stream_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvin_in_stream_V_last_V.dat"
`define AUTOTB_TVIN_in_stream_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvin_in_stream_V_id_V.dat"
`define AUTOTB_TVIN_in_stream_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvin_in_stream_V_dest_V.dat"
...
`define AUTOTB_TVOUT_out_stream_V_data_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_data_V.dat"
`define AUTOTB_TVOUT_out_stream_V_keep_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_keep_V.dat"
`define AUTOTB_TVOUT_out_stream_V_strb_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_strb_V.dat"
`define AUTOTB_TVOUT_out_stream_V_user_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_user_V.dat"
`define AUTOTB_TVOUT_out_stream_V_last_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_last_V.dat"
`define AUTOTB_TVOUT_out_stream_V_id_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_id_V.dat"
`define AUTOTB_TVOUT_out_stream_V_dest_V_out_wrapc  "../tv/rtldatafile/rtl.hyperspectral_hw_wrapped.autotvout_out_stream_V_dest_V.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = 184618;
parameter LENGTH_in_stream_V_data_V = 184410;
parameter LENGTH_in_stream_V_keep_V = 184410;
parameter LENGTH_in_stream_V_strb_V = 184410;
parameter LENGTH_in_stream_V_user_V = 184410;
parameter LENGTH_in_stream_V_last_V = 184410;
parameter LENGTH_in_stream_V_id_V = 184410;
parameter LENGTH_in_stream_V_dest_V = 184410;
parameter LENGTH_out_stream_V_data_V = 93;
parameter LENGTH_out_stream_V_keep_V = 93;
parameter LENGTH_out_stream_V_strb_V = 93;
parameter LENGTH_out_stream_V_user_V = 93;
parameter LENGTH_out_stream_V_last_V = 93;
parameter LENGTH_out_stream_V_id_V = 93;
parameter LENGTH_out_stream_V_dest_V = 93;

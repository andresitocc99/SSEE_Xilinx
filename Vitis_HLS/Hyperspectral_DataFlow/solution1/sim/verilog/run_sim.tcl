...
if {[file isfile hyperspectral_hw_wrapped.autotvin.dat]} {
	file delete -force hyperspectral_hw_wrapped.autotvin.dat
}

if {[file isfile hyperspectral_hw_wrapped.autotvout.dat]} {
	file delete -force hyperspectral_hw_wrapped.autotvout.dat
}

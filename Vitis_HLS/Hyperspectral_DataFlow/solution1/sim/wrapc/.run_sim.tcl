...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "hyperspectral_hw_wrapped.autotvin.dat"
	set constFileTvOut       "hyperspectral_hw_wrapped.autotvout.dat"
	set constFileHdlTvIn     "hyperspectral_hw_wrapped.autohdltvin.dat"
	set constFileHdlTvOut    "hyperspectral_hw_wrapped.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

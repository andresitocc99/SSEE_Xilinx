...
module hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_117_5 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] trunc_ln122_fu_296_p1;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue_int == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((ap_start_int == 1'b0) | ((icmp_ln117_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_condition_229)) begin
        if ((icmp_ln117_fu_138_p2 == 1'd0)) begin
...
always @ (posedge ap_clk) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln117_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (icmp_ln117_fu_138_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if (((ap_start_int == 1'b0) | ((icmp_ln117_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0)))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln117_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (icmp_ln117_fu_138_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln117_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (ap_loop_exit_ready == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_done_int = 1'b1;
    end else begin
...
always @ (*) begin
    if ((~((ap_start_int == 1'b0) | ((icmp_ln117_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1))) begin
        ap_ready_int = 1'b1;
    end else begin
        ap_ready_int = 1'b0;
    end
...
always @ (*) begin
    if (((icmp_ln117_fu_138_p2 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_state1))) begin
...
assign add_ln117_fu_144_p2 = (ap_sig_allocacmp_i + 2'd1);
...
always @ (*) begin
    ap_block_state1_pp0_stage0_iter0 = ((ap_start_int == 1'b0) | ((icmp_ln117_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0)));
end

always @ (*) begin
    ap_condition_229 = (~((ap_start_int == 1'b0) | ((icmp_ln117_fu_138_p2 == 1'd0) & (in_stream_TVALID == 1'b0))) & (1'b1 == ap_CS_fsm_state1));
end

assign ap_loop_exit_ready = ap_condition_exit_pp0_iter0_stage0;

assign icmp_ln117_fu_138_p2 = ((ap_sig_allocacmp_i == 2'd2) ? 1'b1 : 1'b0);
...
assign refPixel_1_5_fu_300_p3 = ((trunc_ln122_fu_296_p1[0:0] == 1'b1) ? result_V_fu_288_p3 : refPixel_1_3_fu_94);

assign refPixel_1_6_fu_308_p3 = ((trunc_ln122_fu_296_p1[0:0] == 1'b1) ? refPixel_1_fu_90 : result_V_fu_288_p3);
...
assign trunc_ln122_fu_296_p1 = ap_sig_allocacmp_i[0:0];
...
endmodule //hyperspectral_hw_wrapped_hyperspectral_hw_wrapped_Pipeline_VITIS_LOOP_117_5

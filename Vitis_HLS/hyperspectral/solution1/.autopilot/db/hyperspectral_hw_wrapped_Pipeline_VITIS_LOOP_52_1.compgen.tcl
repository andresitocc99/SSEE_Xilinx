...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename ref_pixel \
    op interface \
    ports { ref_pixel_address0 { O 8 vector } ref_pixel_ce0 { O 1 bit } ref_pixel_we0 { O 1 bit } ref_pixel_d0 { O 16 vector } ref_pixel_address1 { O 8 vector } ref_pixel_ce1 { O 1 bit } ref_pixel_we1 { O 1 bit } ref_pixel_d1 { O 16 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'ref_pixel'"
}
}

...
extern "C" void mmult_hw_wrapped(volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *, volatile void *);
...
auto* sINPUT_STREAM_V_user_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_INPUT_STREAM_V_user_V);
auto* sINPUT_STREAM_V_last_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_INPUT_STREAM_V_last_V);
auto* sINPUT_STREAM_V_id_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_INPUT_STREAM_V_id_V);
auto* sINPUT_STREAM_V_dest_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_INPUT_STREAM_V_dest_V);
...
auto* sOUTPUT_STREAM_V_user_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_OUTPUT_STREAM_V_user_V);
...
auto* sOUTPUT_STREAM_V_id_V = bcsim::createStream((hls::stream<char>*)__xlx_apatb_param_OUTPUT_STREAM_V_id_V);

...
set name mmult_hw_wrapped_fadd_32ns_32ns_32_5_full_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler $name BINDTYPE {op} TYPE {fadd} IMPL {fulldsp} LATENCY 4 ALLOW_PRAGMA 1
}


set name mmult_hw_wrapped_fmul_32ns_32ns_32_4_max_dsp_1
if {${::AESL::PGuard_rtl_comp_handler}} {
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_sum_v \
    op interface \
    ports { sum_v_dout { I 32 vector } sum_v_empty_n { I 1 bit } sum_v_read { O 1 bit } sum_v_din { O 32 vector } sum_v_full_n { I 1 bit } sum_v_write { O 1 bit } } \
} "
}

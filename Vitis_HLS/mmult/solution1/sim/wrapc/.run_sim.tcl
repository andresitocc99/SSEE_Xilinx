...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "mmult_hw_wrapped.autotvin.dat"
	set constFileTvOut       "mmult_hw_wrapped.autotvout.dat"
	set constFileHdlTvIn     "mmult_hw_wrapped.autohdltvin.dat"
	set constFileHdlTvOut    "mmult_hw_wrapped.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
